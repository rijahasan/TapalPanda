...
namespace Customers {
    ...
    public partial class CustomerInfoDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string Name, string Position) {
        ...
        public partial class CustomersRow : global::System.Data.DataRow {
            ...
            public string Position {
                get {
                    return ((string)(this[this.tableCustomers.PositionColumn]));
                }
                set {
                    this[this.tableCustomers.PositionColumn] = value;
                }
            }
        }
...
namespace Customers.CustomerInfoDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([Position] = @Ori" +
                "ginal_Position))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([Name], [Position]) VALUES (@Name, @Position);\r\nSE" +
                "LECT Id, Name, Position FROM Customers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customers] SET [Name] = @Name, [Position] = @Position WHERE (([Id] " +
                "= @Original_Id) AND ([Position] = @Original_Position));\r\nSELECT Id, Name, Positi" +
                "on FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Customers.Properties.Settings.Default.CustomerInfoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Position FROM dbo.Customers";
        ...
        public virtual int Fill(CustomerInfoDataSet.CustomersDataTable dataTable) {
        ...
        public virtual CustomerInfoDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerInfoDataSet.CustomersDataTable dataTable = new CustomerInfoDataSet.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerInfoDataSet.CustomersDataTable dataTable) {
        ...
        public virtual int Update(string Name, string Position, int Original_Id, string Original_Position, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, int Original_Id, string Original_Position) {
            return this.Update(Name, Position, Original_Id, Original_Position, Original_Id);
        }
    }
